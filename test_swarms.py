...
from baddie_journal import JournalEntry, InsightData, InsightsHelper, JournalAnalysisSwarm
...
def test_insights():
    ...
    entries = [
        ...
        JournalEntry(2, "Productive work", "focused", "work", ["productivity"], datetime.now(UTC) - timedelta(days=1)),
        JournalEntry(3, "Reflection time", "contemplative", "personal", ["reflection"], datetime.now(UTC) - timedelta(days=2))
    ]
