...
def test_notification_service():
    ...
    print(f"  Debug: Days left = {subscription.days_until_trial_end}, Notification = {notification_type}")
...
def test_default_plans():
    ...
    enterprise_plan = next((p for p in DEFAULT_PLANS if p.id == "enterprise-monthly"), None)
