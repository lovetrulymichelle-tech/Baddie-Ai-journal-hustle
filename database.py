    ...
    class DatabaseManager:
        ...
        def __init__(self, database_url=None):
            ...
            if database_url is None:
                database_url = os.getenv('SQLALCHEMY_DATABASE_URI', 'sqlite:///journal.db')
        ...
        def get_all_entries(self):
            ...
            db_entries = self.session.query(JournalEntryDB).order_by(JournalEntryDB.timestamp.desc()).all()
