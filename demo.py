...
def create_sample_data() -> InsightData:
    ...
    entries = [
        JournalEntry(
            id=1,
            content="Started my day with meditation and felt really centered. Work was productive and I accomplished all my goals. Feeling grateful for this positive momentum.",
            mood="happy",
            category="personal",
        ...
        JournalEntry(
            id=2,
            content="Had a challenging day at work with lots of meetings. Felt overwhelmed but managed to push through. Need to work on time management.",
            mood="stressed",
            category="work",
        ...
        JournalEntry(
            id=3,
            content="Great workout this morning! Ran 5k and felt amazing afterward. Energy levels are high and I'm motivated to tackle the day.",
            mood="energetic",
            category="health",
        ...
        JournalEntry(
            id=4,
            content="Spent quality time with family today. Had deep conversations and felt really connected. These moments are what matter most.",
            mood="content",
            category="personal",
        ...
        JournalEntry(
            id=5,
            content="Feeling a bit down today. Not sure why, just one of those days. Tried to stay positive but it's been difficult.",
            mood="melancholy",
            category="personal",
        ...
        JournalEntry(
            id=6,
            content="New day, new perspective! Yesterday's mood has lifted. Started a new project at work and feeling excited about the possibilities.",
            mood="optimistic",
            category="work",
