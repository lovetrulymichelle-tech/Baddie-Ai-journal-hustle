...
class StripeService:
    ...
    def __init__(self, api_key: Optional[str] = None, webhook_secret: Optional[str] = None):
        ...
        if not self.api_key:
            raise ValueError("Stripe API key is required. Set STRIPE_SECRET_KEY environment variable.")
    ...
    def create_trial_subscription(
        ...
        try:
            ...
            logger.info(f"Created trial subscription {subscription.id} for customer {customer_id}")
            ...
            logger.error(f"Failed to create trial subscription for customer {customer_id}: {str(e)}")
    ...
    def upgrade_subscription_after_trial(
        ...
        try:
            ...
            logger.info(f"Upgraded subscription {subscription_id} to plan {new_plan.id}")
    ...
    def cancel_subscription(self, subscription_id: str, at_period_end: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'cancelled_at': datetime.fromtimestamp(subscription.canceled_at, tz=UTC) if subscription.canceled_at else None,
                'current_period_end': datetime.fromtimestamp(subscription.current_period_end, tz=UTC)
            }
    ...
    def get_subscription(self, subscription_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'status': subscription.status,
                'trial_start': datetime.fromtimestamp(subscription.trial_start, tz=UTC) if subscription.trial_start else None,
                'trial_end': datetime.fromtimestamp(subscription.trial_end, tz=UTC) if subscription.trial_end else None,
                'current_period_start': datetime.fromtimestamp(subscription.current_period_start, tz=UTC),
                'current_period_end': datetime.fromtimestamp(subscription.current_period_end, tz=UTC),
                'cancel_at_period_end': subscription.cancel_at_period_end,
                'cancelled_at': datetime.fromtimestamp(subscription.canceled_at, tz=UTC) if subscription.canceled_at else None
    ...
    def handle_webhook_event(self, payload: str, signature: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def _handle_subscription_updated(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'current_period_end': datetime.fromtimestamp(event_data.get('current_period_end', 0), tz=UTC),
    ...
    def _handle_subscription_deleted(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'subscription_id': subscription_id,
            'cancelled_at': datetime.fromtimestamp(event_data.get('canceled_at', 0), tz=UTC),
            'timestamp': datetime.now(UTC)
        }
    ...
    def _handle_trial_will_end(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'subscription_id': subscription_id,
            'trial_end': datetime.fromtimestamp(trial_end, tz=UTC) if trial_end else None,
            'timestamp': datetime.now(UTC)
        }